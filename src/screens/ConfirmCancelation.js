...
const ConfirmCancelation = ({navigation}) => {
  return (
    <ScrollView contentContainerStyle={{
       ...
       <View style ={styles.table}>
        ...
        <Text style ={styles.paidText}>Canceled</Text>
        <Text style ={styles.price}>Refund Completed</Text>
  ...
  <Text style={styles.arrivalTime}>Destination: Wakad, Pune (2:30 PM)</Text>
    ...
    <TouchableOpacity style={styles.ProceedButton} onPress={() => navigation.navigate('Main')} >
