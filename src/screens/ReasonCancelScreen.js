...
const ReasonCancelScreen = ({navigation}) => {
  ...
  <Text style={styles.arrivalTime}>Destination: Wakad, Pune (2:30 PM)</Text>
      ...
      <Text style ={styles.reasonCancel}>Why are you Canceling ?</Text>
      ...
      secureTextEntry
      keyboardType='text'/>
    <TouchableOpacity style={styles.ProceedButton} onPress={() => navigation.navigate("Confirm_cancel")}>
...
export default ReasonCancelScreen
